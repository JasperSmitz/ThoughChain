...
{findings}
Please ensure the report is structured with an introduction, methods, results, and discussion sections. The report should be concise, scientifically rigorous, and suitable for publication in a peer-reviewed journal. Include the title of the references used.
...
Only write the report, do not include any additional text or explanations.
"""
